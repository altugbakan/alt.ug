        ...
        <div className="relative">
                                ...
                                Logos.map((logo) => {
                                    return (
                                        <a key={logo.href} href={logo.href} target="_blank" rel="noreferrer" className="ml-4 mt-2">
                                            <svg className={"group fill-zinc-400 hover:scale-125 w-8 h-8"} viewBox={logo.viewBox}>
                                                {logo.image}
                                            </svg>
                                        </a>
                                    );
            ...
            </nav>
            {
                width > 768 ?
                    null
                    :
                    <div className={`${hidden ? "hidden" : "flex"} flex-col justify-center text-center fixed right-1 w-3/5 bg-zinc-700 text-zinc-400 rounded-md`} ref={ref}>
                        {
                            <ul className="mb-8 mt-8 divide-y-2 divide-zinc-600">
                                {
                                    Logos.map((logo) => {
                                        return (
                                            <li key={logo.name}>
                                                <a className="group" href={logo.href} target="_blank" rel="noreferrer">
