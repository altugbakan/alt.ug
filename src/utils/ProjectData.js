import ArduinoSpotifyController from "../images/arduinospotifycontroller.png";
import Gums from "../images/gums.gif";
...
const ProjectData = [
    ...
    {
        name: "The Loan Stream", href: "https://thels.vercel.app/",
        img: Thels, description: "A novel DeFi protocol that allows you to borrow money streams without selling your collateral.",
    ...
    {
        name: "Stellar Quest Go", href: "https://quest.stellar.org/",
        img: StellarQuestGo, description: "Solutions for Stellar Quest in Go using the Stellar Go SDK.",
        github: "https://github.com/altugbakan/stellar-quest-go",
    },
    {
        name: "Vanity MonKey Generator", href: "https://vanitymonkeygenerator.gitbook.io/",
        img: VanityMonKeyGenerator, description: "Generates an account with a custom MonKey for Banano cryptocurrency.",
        github: "https://github.com/altugbakan/vanity-monkey-generator",
    }
];
